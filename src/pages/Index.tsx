...
const FEATURES = [
  {
    ...
    desc: "AES-256 — один из самых надёжных стандартов защиты данных. Ваша информация полностью закрыта от посторонних.",
    color: "cyan",
  },
  {
    icon: "EyeOff",
    title: "Скрытый IP-адрес",
    desc: "Ваш настоящий IP скрыт — сайты и сервисы не знают, кто вы и откуда заходите.",
    color: "blue",
  },
  {
    icon: "Wifi",
    title: "Защита DNS",
    desc: "Ваш интернет-провайдер не видит, какие сайты вы посещаете. Всё остаётся только между вами и сетью.",
    color: "green",
  },
  {
    icon: "Zap",
    title: "Высокая скорость",
    desc: "Быстрые серверы по всему миру — сёрфинг, стриминг и звонки без тормозов и задержек.",
    color: "cyan",
  },
  {
    icon: "Smartphone",
    title: "Все устройства",
    desc: "Работает на телефоне, компьютере и планшете. Один аккаунт — до 4 устройств одновременно.",
    color: "green",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center py-20">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up-delay-3">
              <button className="btn-neon px-8 py-4 rounded-xl text-base flex items-center justify-center" onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}>Начать защиту</button>
